...
const displayVideos = (videos) => {
    ...
    videos.forEach((video) => {
        ...
        `<figure class="h-[200px] relative">
            ...
            ${
                video.others.posted_date?.length == 0 ? "" :  `<span class="absolute right-2 bottom-1 bg-slate-500 text-white rounded p-1">${getTimeString(video.others.posted_date)}</span>`
            }    
